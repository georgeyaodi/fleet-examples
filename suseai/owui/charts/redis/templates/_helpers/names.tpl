...
*/}}
{{- define "application-collection.chart" }}
...
*/}}
{{- define "application-collection.name" }}
...
*/}}
{{- define "application-collection.fullName" }}
...
*/}}
{{- define "application-collection.containerName" -}}
    {{- lower . }}
{{- end -}}
...
*/}}
{{- define "application-collection.serviceAccountName" -}}
    {{- if .Values.serviceAccount.create -}}
        {{- default (include "application-collection.fullName" .) .Values.serviceAccount.name }}
    {{- else -}}
