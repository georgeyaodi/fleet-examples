...
```console
helm install my-release ${CHART_REGISTRY}/charts/redis
```
...
```console
helm install my-release --set images.redis.tag=${APP_VERSION} ${CHART_REGISTRY}/charts/redis
```

Alternatively, you can override the parameter values using a custom YAML file with the *-f* flag. For example:

```console
helm install my-release -f custom-values.yaml ${CHART_REGISTRY}/charts/redis
```
